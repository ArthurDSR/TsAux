...
const pontosDeDescarte = [
  ...
  new PontoDeDescarte(
    "Sucataço",
    "03138485544",
    "Avenida Emalto 180 - Núcleo industrial",
    "",
    []
  ),
  new PontoDeDescarte(
    "EcoMetals",
    "031973019352",
    "BR-381, 200 - Núcleo De Industrial, Timóteo - MG",
    "",
    ["Eletrônicos"]
  ),
  new PontoDeDescarte(
    "Sucatão ViraMundo",
    "0313414789",
    "Avenida  Presidente Tancredo de Almeida Neves,Cel. Fabriciano - MG",
    "",
    ["Placa de computador, sucata"]
  ),
  new PontoDeDescarte(
    "Reciclagem Pais e Filhos",
    "031986556992",
    "Chácaras Oliveira, Ipatinga-MG",
  ...
  new PontoDeDescarte(
    "EcoVale",
    "",
    "Rua Paquetá 137 - Coronel Fabriciano-MG",
    "http://ecovalereciclagem.com.br/",
    ["Diversos materiais"]
  ),
  new PontoDeDescarte(
    "Garrafaria Moreira",
    "",
    "Avenida Presidente Tancredo Neves 4634, Coronel Fabriciano-MG",
    "",
  ...
  new PontoDeDescarte(
    "Reciclagem Ipatinga",
    "",
    "Rua Alfazema 184 - Esperança, Ipatinga-MG",
    "",
  ...
  new PontoDeDescarte(
    "BioVale",
    "031999938150",
    "Avenida Sanitária, 2311 - Limoeiro, Ipatinga-MG",
  ...
  new PontoDeDescarte(
    "Arena da Mata",
    "",
    "R. Palmeiras, 1010 - Horto, Ipatinga - MG",
    "",
    []
  ),
  new PontoDeDescarte(
    "TechSmart",
    "",
    "Praça Natsuo Esaki, 3241 - Cariru, Ipatinga",
    "",
    []
  ),
  new PontoDeDescarte(
    "Casa Ganja",
    "",
    "Av. Carlos Chagas, 659 - Cidade Nobre, Ipatinga - MG",
    "http://reciclagemverdevida.com.br",
    []
  ),
  new PontoDeDescarte(
    "Vaz Informática",
    "",
    "R. Dom Pedro I, 116 - Cidade Nobre, Ipatinga - MG",
    "",
    []
  ),
  new PontoDeDescarte(
    "Velha Amiga Tattoo",
    "",
    "R. João Monlevade, 88 - Cidade Nobre, Ipatinga - MG",
    "",
    []
  ),
  new PontoDeDescarte(
...
function success(pos) {
  ...
  marker = L.marker([abscissa, ordenada], { icon: iconecopessoa })
    .on("click", onClick)
  ...
  pontosDeDescarte.forEach((ponto) => {
    fetch(
      ...
      .then((data) => {
        var lat = data[0].lat;
        var lon = data[0].lon;
        marker = L.marker([lat, lon], { icon: iconecoponto })
          .on("click", onClick)
          .on("mouseover", onMouseOver)
          .on("mouseout", onMouseOut)
          .addTo(map);
